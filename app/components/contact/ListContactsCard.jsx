          ...
          <div className="w-full">
            {props.dataItem.map((item, index) => {
              return (
                <div
                  key={index}
                  className="cursor-pointer col-span-2 !transition-all mt-3 ease-in-out hover:-translate-y-1 hover:scale-95 p-3 bg-gray-600 rounded-lg bg-blue-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-30 hover:bg-opacity-50 border border-gray-100"
                >
